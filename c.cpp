...
public:
    ...
    void apply_interest() {
        ...
        deposit(interest);  // Deposit the calculated interest into the account
...
int main() {
    ...
    BankAccount account1("121807", "Lina", 1000.0);
    ...
    SavingsAccount savings_account("12921", "Sonya", 2000.0, 5.0); // Interest rate 5%
